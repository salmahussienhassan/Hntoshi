...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [TranslateModule, RouterLink,ReactiveFormsModule, CommonModule, BlogCardsComponent ,NoNumbersDirective,OnlyNumbersDirective],
...
this.consultationService.createConsultation(form.value).subscribe({
  ...
  // Method to toggle the visibility of social icons
  showSocialIcons(){
    this.showIcons = !this.showIcons;  // Toggle the state of showIcons
